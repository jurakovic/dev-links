...
function update() {
  ...
  curl -sI https://tidyfirst.substack.com/feed
  curl -s --compressed -L -H 'user-agent: Mozilla/5.0' 'https://tidyfirst.substack.com/feed' | head -20
  curl -s --compressed -L -H 'user-agent: Mozilla/5.0' 'https://tidyfirst.substack.com/feed'
